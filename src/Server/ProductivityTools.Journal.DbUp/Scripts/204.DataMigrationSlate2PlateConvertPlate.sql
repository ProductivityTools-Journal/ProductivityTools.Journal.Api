...
Update [PTJournal].[j].[Page] set Content=REPLACE(Content,'"type":"table-row"','"type":"tr"') 
Update [PTJournal].[j].[Page] set Content=REPLACE(Content,'"type":"table-cell"','"type":"td"') 


update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)
update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)-- where PageId=3145
update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)
update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)
update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)
update [PTJournal].[j].[Page] set Content=dbo.UpdateList(Content)
