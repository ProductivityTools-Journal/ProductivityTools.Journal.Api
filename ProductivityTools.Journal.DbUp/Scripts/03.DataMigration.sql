...
insert into [PTJournal].[j].[Page]([JournalId],[Subject],[NotesNotes],[Type],Deleted)
SELECT journal.TreeId,journal.[Subject],notes.Notes,notes.[NotesType],journal.Deleted 
